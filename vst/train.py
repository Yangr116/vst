...
def main():
    ...
    if args.model.add_tokens is not None:
        add_tokens =  args.model.add_tokens
        add_tokens = [AddedToken(x, special=True) for x in add_tokens]
        add_tokens = tokenizer.additional_special_tokens + add_tokens
    ...
    for epoch in range(start_epoch, args.train.num_train_epochs):
        ...
        for _ in range(start_step, args.train.train_steps):
            ...
            for micro_batch in micro_batches:
                ...
                # micro_batch['position_ids'].shape = torch.Size([1, 3, N])
